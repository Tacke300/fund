        ...
        try {
            if (id === 'binanceusdm') {
                ...
                try {
                    ...
                    // CCXT có thể cung cấp raw response trong e.response
                ...
                try {
                    ...
                    for (const market of bingxMarkets) {
                        ...
                        // debugRawLeverageResponses.bingx được cập nhật bởi fetchBingxMaxLeverage (lần gọi cuối cùng của vòng lặp)
