...
class BotEngine {
    ...
    // [BẢN SỬA 2: LÀM TRÒN ĐÒN BẨY CHO KUCOIN]
    ...
    async executeTrade(op) {
        ...
        // setLeverageSafely đã ép CROSS và làm tròn cho Kucoin
        ...
        // [BẢN SỬA 2: THÊM LEVERAGE VÀO PARAMS]
        // Kucoin cần làm tròn đòn bẩy
