...
app.get('/gui', (req, res) => {
    ...
    <div class="px-4 mt-4"><div class="bg-card rounded-lg p-3">
         <div class="text-[10px] font-bold text-gray-custom mb-2 uppercase italic border-b border-zinc-800 pb-1">Biến động thị trường</div>
    ...
    <div class="px-4 mt-4 pb-32"><div class="bg-card rounded-lg p-3">
        ...
        <table class="w-full text-[8px] text-left"><thead class="text-gray-custom border-b border-zinc-800">
            <tr><th>Time</th><th>Coin</th><th>Margin</th><th class="text-center">Lev/Target</th><th>Entry/Exit</th><th>PnL Net</th><th class="text-right">Balance</th></tr>
