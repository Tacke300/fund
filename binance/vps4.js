...
const BOT_ID = process.env.name || 'vps4';
...
const SIDEWAYS_CHECK_INTERVAL_MS = 2.9 * 60 * 1000;
...
const MODE_SWITCH_DELAY_MS = 35000;
const COIN_SWITCH_DELAY_MS = 35000;
const KILL_MODE_SWITCH_CHECK_INTERVAL_MS = 2.2 * 60 * 1000;
