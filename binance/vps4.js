...
const BOT_ID = process.env.name || 'sever4';
...
const SIDEWAYS_CHECK_INTERVAL_MS = 0.4 * 60 * 1000;
...
const MODE_SWITCH_DELAY_MS = 20000;
const COIN_SWITCH_DELAY_MS = 20000;
const KILL_MODE_SWITCH_CHECK_INTERVAL_MS = 0.4 * 60 * 1000;
