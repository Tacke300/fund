...
<head>
    ...
    <style>
        body {
            ...
            margin: 20px;
            background-color: #2c2c2c; /* Đen xám huyền bí */
            color: #e0e0e0; /* Chữ xám nhạt */
            line-height: 1;
            text-align: center;
        }
        .container {
            max-width: 900px;
            margin: 30px auto;
            background-color: #3c3c3c; /* Hộp chứa tối hơn */
            padding: 30px;
            border-radius: 12px;
            box-shadow: 0 6px 20px rgba(0, 0, 0, 0.2); /* Đổ bóng nhẹ nhàng */
        }
        h1, h2 {
            color: #78a4e8; /* Xanh lam nhạt */
            text-align: center;
            margin-bottom: 20px;
        }
        .form-group {
        ...
        .form-group input[type="password"] {
            width: calc(100% - 20px);
            padding: 12px;
            border: 1px solid #5a5a5a; /* Border tối hơn */
            border-radius: 8px;
            font-size: 1em;
            box-sizing: border-box;
            background-color: #4a4a4a; /* Nền input tối */
    ...
    <script>
        // ĐÃ XÓA CÁC ĐỊNH NGHĨA apiKeyInput VÀ secretKeyInput TẠI ĐÂY
        ...
        function loadConfig() {
            // ĐÃ XÓA CÁC DÒNG ĐỌC API KEY VÀ SECRET KEY TỪ LOCAL STORAGE
        ...
        function saveConfigToLocalStorage() {
            // ĐÃ XÓA CÁC DÒNG LƯU API KEY VÀ SECRET KEY VÀO LOCAL STORAGE
        ...
        saveConfigBtn.addEventListener('click', async () => {
            ...
            // ĐÃ XÓA PHẦN KIỂM TRA API KEY VÀ SECRET KEY TẠI ĐÂY
            ...
            const configToSend = {
                // ĐÃ XÓA API KEY VÀ SECRET KEY KHỎI ĐỐI TƯỢNG GỬI ĐI
        ...
        async function fetchLogs() {
                ...
                // currentPositionsTableBody.innerHTML = '<tr><td colspan="5" style="text-align: center; color: red;">Lỗi tải thống kê.</td></tr>'; // Commented out as element is not present
            }
        }
        ...
        startBotBtn.addEventListener('click', async () => {
            ...
            // ĐÃ XÓA PHẦN KIỂM TRA API KEY VÀ SECRET KEY TẠI ĐÂY KHI START
            // if (!apiKeyInput.value.trim() || !secretKeyInput.value.trim()) {
