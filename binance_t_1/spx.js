...
const BOT_LOG_FILE = `/home/tacke300/.pm2/logs/${process.env.name || 'spx'}-out.log`; 
// Tên của bot trong PM2, phải khớp với tên bạn đã dùng khi start bot bằng PM2.
const THIS_BOT_PM2_NAME = process.env.name || 'spx'; // SỬA ĐỂ LẤY TỪ PM2 ENV HOẶC MẶC ĐỊNH
