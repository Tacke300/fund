...
const WEB_SERVER_PORT = 1237; // Cổng cho giao diện web
// Đường dẫn tới file log của PM2 cho bot này. CẦN CHỈNH SỬA ĐỂ KHỚP VỚI TÊN PM2 CỦA BẠN
const BOT_LOG_FILE = `/home/tacke300/.pm2/logs/${process.env.name || 'bot01'}-out.log`; 
// Tên của bot trong PM2, phải khớp với tên bạn đã dùng khi start bot bằng PM2.
const THIS_BOT_PM2_NAME = process.env.name || 'bot01'; // SỬA ĐỂ LẤY TỪ PM2 ENV HOẶC MẶC ĐỊNH
